...
export const renameSecretsInstance = (collectionPathname, oldName, newName) => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    ipcRenderer
      .invoke('renderer:rename-secrets-instance', collectionPathname, oldName, newName)
      .then(resolve)
      .catch(reject);
  });
};
